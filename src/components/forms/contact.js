      ...
      return(  
          ...
          <body className="form_body"> 
            ...
            <Form.Group className="form_input" controlId="exampleForm.ControlInput1">
              ...
              <Form.Control type="email" name="email" value={this.state.email}onChange={this.handleChange.bind(this, 'email')} label="email" placeholder="name@example.com" />
            </Form.Group>
            ...
            <Form.Group className="form_input"  controlId="exampleForm.ControlSelect1">
              <Form.Label className="labels">Example select:</Form.Label>
                <Form.Control type="text" name="job" label="job" onChange={this.handleChange.bind(this, 'job')} value={this.state.job} as="select">
            ...
            <Form.Group className="form_input"  controlId="exampleForm.ControlTextarea1">
              <Form.Label type="textarea" name="message" label="message" className="labels" value={this.state.message} onChange={this.handleChange.bind(this, 'message')}>More Information:</Form.Label>
