    ...
    return(
        ...
        <header className="headerStyle">
            ...
            <div className="hero_text">
    	        <h1 className="header_text">Development Designed For The Digital World. <Button href="#home_section" style={{color: "white"}}variant="outline-secondary">More about me</Button></h1>
            ...
            <div className="card_style"> 
                ...
                <Card className="cards" style={{ width: '16rem', height:'10rem'  }}>
                    <Card.Body>
                        ...
                        <Card.Text>
                            See what I have developed in the past for exisiting businesses and see some of my passion projects.
                        </Card.Text>     
                    </Card.Body>
                </Card> 
                </Link>
